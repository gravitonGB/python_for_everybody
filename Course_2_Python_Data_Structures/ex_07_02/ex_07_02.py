...
for line in fh:
    ...
    total_confidance = confidance + total_confidance
average_confidance = total_confidance / count
print('Average spam confidence:',average_confidance)
